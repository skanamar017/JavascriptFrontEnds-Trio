...
VALUES
    ...
    (35, 'Clefairy', 'Normal', NULL, 70, 45, 48, 60, 35, "A cute Pokémon that is known for its playful nature."),
    (36, 'Clefable', 'Normal', NULL, 95, 70, 73, 85, 60, "An evolved form of Clefairy, known for its magical abilities."),
    ...
    (39, 'Jigglypuff', 'Normal', NULL, 115, 45, 20, 25, 20, "A balloon-like Pokémon that is known for its singing ability."),
    (40, 'Wigglytuff', 'Normal', NULL, 140, 70, 45, 50, 45, "An evolved form of Jigglypuff, known for its large size and strength."),
    ...
    (122, 'Mr. Mime', 'Psychic', NULL, 40, 45, 65, 100, 90, "A Pokémon that is known for its mime skills and ability to create barriers."),
