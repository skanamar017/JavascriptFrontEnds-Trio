<!-- filepath: /Users/sai/Documents/Projects/eighth-week/JavascriptFrontEnds-Trio/src/vuejs/vue-frontend/src/components/EditPokemon.vue -->
<script setup>
...
onMounted(() => {
  if (props.pokemon) {
    Object.assign(pokemonForm, props.pokemon);
  }
});
...
const submitForm = async () => {
  ...
  try {
    ...
    // Update Pokemon
    await pokemonStore.updateTrainerPokemon(props.trainerId, props.pokemon.id, pokemonData);

    // Emit success to parent
    emit("success");
  } catch (err) {
    console.error("Failed to update Pokemon:", err);
    alert("Failed to update Pokemon. Please check the console for details.");
  } finally {
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input
              ...
              disabled
            />
            <small>Pokemon species cannot be changed</small>
          </div>
